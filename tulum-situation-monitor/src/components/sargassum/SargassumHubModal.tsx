      ...
      >
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "16px", display: "flex", flexDirection: "column", gap: "16px", paddingBottom: isMobile ? "100px" : "24px" }}>
          ...
          <div style={sectionCardStyle}>
            ...
            <div style={{ background: "#111", padding: "8px", display: "flex", justifyContent: "center" }}>
              {imageErrors.current ? (
                <div style={{ height: "200px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", color: "rgba(255,255,255,0.4)" }}>
